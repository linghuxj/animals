      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-10 lg:col-span-9 grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="text-sm">
                <h6 className="font-medium uppercase mb-2">产品</h6>
                <ul>
                  <li className="mb-1">
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="font-medium uppercase mb-2">渠道</h6>
                <ul>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href="#0">
                      公众号
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="font-medium uppercase mb-2">公司相关</h6>
                <ul>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href="#0">
                      深圳市一卡通新技术有限公司
              ...
              {/* 5th block */}
              <div className="text-sm">
                <h6 className="font-medium uppercase mb-2">技术支持</h6>
                <ul>
                  <li className="mb-1">
                    <a className="text-gray-600 dark:text-gray-400 hover:underline transition duration-150 ease-in-out" href="#0">
                      文档
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-600 dark:text-gray-400 text-sm mr-4">&copy; Smtro.com. @2024 All rights reserved.</div>
          </div>
        </div>
      </div>
    </footer>
