      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="h1 font-red-hat-display mb-4" data-aos="fade-down">您需要什么帮助？</h1>
            <p className="text-xl text-gray-600 dark:text-gray-400" data-aos="fade-down" data-aos-delay="150">详细的介绍内容和使用指引可以更好的帮助您了解该项目.</p>
            <div className="max-w-2xl mx-auto md:px-4">
              <form className="relative flex items-center mt-8" data-aos="fade-down" data-aos-delay="300">
                <input type="search" className="form-input w-full pl-12" placeholder="搜索您想要的任何内容..." aria-label="Search" />
